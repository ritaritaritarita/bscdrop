...
contract MerkleDistributor is IMerkleDistributor, Ownable {
    ...
    constructor(bytes32 merkleRoot_, uint _pepemonId, address factory) public {
    ...
    function isAddressClaimed(address addr) public view returns (bool) {
        return isClaimed(uint256(addr));
    }
    ...
    function claim(uint256 index, address account, uint256 amount, bytes32[] calldata merkleProof) external override {
        require(!isClaimed(uint256(account)), 'MerkleDistributor: Drop already claimed.');
